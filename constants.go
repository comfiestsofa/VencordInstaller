...
const InstallerReleaseUrl = "https://api.github.com/repos/comfiestsofa/VencordInstaller/releases/latest"
const InstallerReleaseUrlFallback = "https://vencord.dev/releases/installer"

var UserAgent = "VencordInstaller/" + buildinfo.InstallerGitHash + " (https://github.com/comfiestsofa/VencordInstaller)"
